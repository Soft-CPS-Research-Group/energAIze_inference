...
def test_replay_new_headquarters_messages_without_flex(boavista_without_flex_client):
...
def test_price_vector_does_not_change_dispatch_without_flex(boavista_without_flex_client):
