...
def test_rh1_grid_meter_is_used_as_primary_site_balance_signal(rh1_client):
    payload = {
        ...
        "observations": {
            ...
            "grid_meters": {
                "GR01": {
                    "energy_in_total": _kwh_for_interval(3.0),
                    "energy_in_l1": _kwh_for_interval(1.0),
                    "energy_in_l2": _kwh_for_interval(1.0),
                    "energy_in_l3": _kwh_for_interval(1.0),
...
def test_rh1_small_meter_energy_interval_drives_nonzero_battery_dispatch(rh1_client):
    payload = {
        "timestamp": "2026-03-01T10:00:00Z",
        "observations": {
            "non_shiftable_load": 0.0,
